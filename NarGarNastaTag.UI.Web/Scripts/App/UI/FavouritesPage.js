...
(function (Commuter) {
    (function (UI) {
        ...
        (function (FavouritesPage) {
            FavouritesPage.stations = [];
            function load() {
                showFavourites();
                route = new Commuter.Trains.Entities.Route();
            }
            FavouritesPage.load = load;
            ...
            function getStations() {
                if(FavouritesPage.stations.length > 0) {
                    return;
                }
                commuterController.scrapeStations(function (context) {
                    try  {
                        $.each(context.data, function () {
                            if(this && !FavouritesPage.stations) {
                                FavouritesPage.stations = [];
                                FavouritesPage.stations.push(this);
                            } else {
                                if(this) {
                                    FavouritesPage.stations.push(this);
                                }
            ...
            function loading() {
                ...
                $('.searchStations').on('input', function () {
                    ...
                    delay(function () {
                        ...
                        ; ;
                        var items = [];
                        $.each(FavouritesPage.stations, function () {
            ...
            FavouritesPage.loading = loading;
            var delay = (function () {
                var timer = 0;
        ...
        })(UI.FavouritesPage || (UI.FavouritesPage = {}));
        var FavouritesPage = UI.FavouritesPage;
    })(Commuter.UI || (Commuter.UI = {}));
    var UI = Commuter.UI;
})(Commuter || (Commuter = {}));
//@ sourceMappingURL=FavouritesPage.js.map
